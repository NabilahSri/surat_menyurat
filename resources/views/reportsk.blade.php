              ...
              <form method="get" action="/report-sk/action" onsubmit="return validateForm()">
                <div class="d-flex ustify-content-between">
                  <div class="row g-3 align-items-center me-5">
                    ...
                    <div class="col-auto">
                      <input type="date" name="tanggal_awal" id="tanggal_awal" placeholder="sampai tanggal" class="form-control">
                    </div>
                  </div>
                  <div class="row g-3 align-items-center me-5">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                      <input type="date" name="tanggal_akhir" id="tanggal_akhir" placeholder="sampai tanggal" class="form-control">
                    </div>
                  </div>
                  <div class="row g-3 align-items-center me-5">
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">unit kerja / bagian</label>
                    </div>
                    <div class="col-auto">
